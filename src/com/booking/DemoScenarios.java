...
/**
 * Contient les scénarios automatiques et les démonstrations (polymorphisme, collections).
 */
public class DemoScenarios {
    ...
    public DemoScenarios(CollectionHebergements collection, AuthService authService) {
     ...
     */
    public void scenario1_NouveauClient() {
     ...
     */
    public void scenario2_AncienClient() {
        System.out.println("═".repeat(60));
     ...
     */
    public void scenario3_Administrateur() {
        System.out.println("═".repeat(60));
     ...
     */
    public void demonstrationPolymorphisme() {
        System.out.println("═".repeat(60));
     ...
     */
    public void demonstrationCollections() {
        System.out.println("═".repeat(60));
